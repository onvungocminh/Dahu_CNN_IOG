...
p['valBatch'] = 2 # Training batch size 5
...
if resume_epoch != nEpochs:
    ...
    trainloader = DataLoader(db_train, batch_size=p['trainBatch'], shuffle=True, num_workers=20, drop_last=True)
    valloader = DataLoader(db_val, batch_size=p['valBatch'], shuffle=False, num_workers=20, drop_last=True)
